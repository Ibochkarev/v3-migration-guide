...
[Флаг миграционной сборки: `CONFIG_PRODUCTION_TIP`](../migration-build.html#compat-configuration)
...
[Флаг миграционной сборки: `CONFIG_IGNORED_ELEMENTS`](../migration-build.html#compat-configuration)
...
The equivalent in Vue 3 is [`config.globalProperties`](https://ru.vuejs.org/api/application.html#app-config-globalproperties). These properties will be copied across as part of instantiating a component within the application:
...
[Флаг миграционной сборки: `GLOBAL_PROTOTYPE`](../migration-build.html#compat-configuration)
...
In Vue 3, we strongly recommend favoring composition via [Composition API](https://ru.vuejs.org/guide/reusability/composables.html) over inheritance and mixins. If for some reason you still need component inheritance, you can use the [`extends` option](https://ru.vuejs.org/api/options-composition.html#extends) instead of `Vue.extend`.

[Флаг миграционной сборки: `GLOBAL_EXTEND`](../migration-build.html#compat-configuration)
...
[Флаг миграционной сборки: `GLOBAL_MOUNT`](../migration-build.html#compat-configuration)
